...
namespace SmartBoard.WebUI.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //var callbackUrl = Url.Page("/Account/ConfirmEmail", null, new {userId = user.Id, code = code,returnUrl = returnUrl }, Request.Scheme);
